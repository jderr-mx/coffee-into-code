...
export default class PostCard extends Component {
  ...
  let content = this.post.content;
    if(content.length <= summaryLength) {
      ...
      return htmlSafe(converter.makeHtml(abbrevContent) + htmlSafe(' <span class="text-gray-800">[more]</span>'));
    }
  }

  get altText() {
    return this.post.imageMeta.altText ? this.post.imageMeta.altText : "";
  }
}
